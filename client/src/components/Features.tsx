        ...
        <section id="features" className="py-20 2xl:py-32">
            <div className="max-w-6xl mx-auto px-4">
                ...
                <Title
                    ...
                    description="Our AI instantly produces professional, high-performing ads that are ready to run on social media, websites, and more. No design or marketing experience required."
                />
